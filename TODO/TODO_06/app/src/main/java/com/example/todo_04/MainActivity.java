...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            Boolean isVisible = savedInstanceState.getBoolean("MainActivity_TextView01_visible");
            if(isVisible){
                MainActivity_TextView01.setVisibility(View.VISIBLE);
                MainActivity_TextView02.setText(savedInstanceState.getString("MainActivity_TextView02_text"));
            }
        }
    }
    ...
    protected void onSaveInstanceState(@NonNull Bundle bundle){
        ...
        if(MainActivity_TextView01.getVisibility() == View.VISIBLE){
            bundle.putBoolean("MainActivity_TextView01_visible",true);
            bundle.putString("MainActivity_TextView02_text",received_reply);
        }
    }
}